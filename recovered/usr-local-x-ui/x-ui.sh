...
legacy_version() {
    ...
    download_link="https://raw.githubusercontent.com/kelenetwork/x-ui-recovered/main/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/kelenetwork/x-ui-recovered/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://raw.githubusercontent.com/kelenetwork/x-ui-recovered/main/recovered/usr-local-x-ui/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
